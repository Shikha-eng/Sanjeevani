...
export default function PatientLayout({ children }: { children: React.ReactNode }) {
    ...
    const navItems = [
        ...
        { name: "AI Assistant", path: "/patient/assistant", icon: "🤖" },
        { name: "Appointments", path: "/patient/appointments", icon: "📅" },
        { name: "Pharmacy", path: "/patient/pharmacy", icon: "💊" },
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row min-h-[calc(100vh-64px)]">
            ...
            <div className="md:w-64 bg-white border-r border-gray-100 shadow-sm md:flex-shrink-0 hidden md:block">
                <div className="p-4">
                    <h2 className="text-sm font-bold text-gray-400 uppercase tracking-wider">Patient Portal</h2>
